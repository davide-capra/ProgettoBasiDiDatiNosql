...
beginning = time.time()
res = graph.run("""
    MATCH (l:Lawyers {id: '3'})-[:IS_INVOLVED]->(Claims)<-[:HAS_CLAIM]-(c)
...
with open('C:\\Users\\39377\\Desktop\\ProgettoDbNoSql\\Neo4j\\RisultatiNeo4j\\Query100%\\QueryIII100%.csv', 'w') as results:
